      ...
      fun c () ->
        ...
        let full_cb = [%client fun e ->
             ...
             try
               ...
               let _ =
                 let%lwt res = get_from_server ~%coservice (~%get_values (), ~%d) in
                 Lwt.cancel canceled;
                 enable_everything ();
